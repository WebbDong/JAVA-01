...
import com.webbdong.sharding.properties.DataSourceProperties;
...
public class ShardingOrderTableCreator {
    ...
    public void reCreateAllShardingTables() {
        createShardingOrderTables(dataSourceProperties.getOrderds0JdbcUrl(),
                dataSourceProperties.getOrderds0Username(),
                dataSourceProperties.getOrderds0Password());

        createShardingOrderTables(dataSourceProperties.getOrderds1JdbcUrl(),
                dataSourceProperties.getOrderds1Username(),
                dataSourceProperties.getOrderds1Password());

        createShardingOrderTables(dataSourceProperties.getOrderds2JdbcUrl(),
                dataSourceProperties.getOrderds2Username(),
                dataSourceProperties.getOrderds2Password());

        createShardingOrderTables(dataSourceProperties.getOrderds3JdbcUrl(),
                dataSourceProperties.getOrderds3Username(),
                dataSourceProperties.getOrderds3Password());
    }
